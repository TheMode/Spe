...
public class FactorialTest {
    ...
    public void separateFile() {
        Factorial function = Spe.compile("factorial", Factorial.class, FactorialImpl.class);
    ...
    public void innerImpl() {
        Factorial function = Spe.compile("factorial", Factorial.class, InnerFactorial.class);
        assertEquals(1, function.factorial(1));
        assertEquals(2, function.factorial(2));
        assertEquals(6, function.factorial(3));
        assertEquals(24, function.factorial(4));
    ...
    private static final class InnerFactorial implements Factorial {
        @Override
